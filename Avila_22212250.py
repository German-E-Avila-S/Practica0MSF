...
Kp,Ki,Kd = 293.7226,7260.9609,0.39165
Cr = 1E-6
Re = 1/(Ki*Cr)
Rr = Kp*Re
Ce = Kd/Rr
...
plt.show()
fgl.savefig('step_python.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2),loc = 'center', ncol = 3,
            fontsize = 9, frameon = True)
plt.show()
fgl.savefig('impulso_python.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2),loc = 'center', ncol = 3,
            fontsize = 9, frameon = True)
plt.show()
fgl.savefig('rampa_python.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2),loc = 'center', ncol = 3,
            fontsize = 9, frameon = True)
plt.show()
fgl.savefig('sin_python.pdf',bbox_inches = 'tight')